...
namespace FacturacionSysDLL.DATA
{
    ...
    public partial class FacturacionSysDBEntities : DbContext
    {
        public FacturacionSysDBEntities()
            : base("name=FacturacionSysDBEntities")
        {
        }
        ...
        public virtual DbSet<TBL_Factura_D> TBL_Factura_D { get; set; }
        public virtual DbSet<TBL_InventarioMovimiento> TBL_InventarioMovimiento { get; set; }
        public virtual DbSet<TBL_InventarioMovimiento_D> TBL_InventarioMovimiento_D { get; set; }
